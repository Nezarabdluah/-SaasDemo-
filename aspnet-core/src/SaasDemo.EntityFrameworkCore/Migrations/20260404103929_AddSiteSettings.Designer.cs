...
{
    [DbContext(typeof(SaasDemoDbContext))]
    [Migration("20260404103929_AddSiteSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppBlogCategories", (string)null);
                });

            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPostCategory", b =>
                {
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPostTag", b =>
                {
                    b.Property<Guid>("BlogPostId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPostVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBlogPostVersions", (string)null);
                });

            modelBuilder.Entity("SaasDemo.BlogPosts.BlogTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBlogTags", (string)null);
                });

            modelBuilder.Entity("SaasDemo.BlogPosts.SlugRedirect", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSlugRedirects", (string)null);
                });

            modelBuilder.Entity("SaasDemo.MediaLibrary.MediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SaasDemo.Settings.SiteSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSiteSettings", (string)null);
                });
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPostCategory", b =>
                {
                    b.HasOne("SaasDemo.BlogPosts.BlogCategory", null)
                        .WithMany()
                        .HasForeignKey("BlogCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SaasDemo.BlogPosts.BlogPost", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SaasDemo.BlogPosts.BlogPostTag", b =>
                {
                    ...
                    b.HasOne("SaasDemo.BlogPosts.BlogTag", null)
                        .WithMany()
